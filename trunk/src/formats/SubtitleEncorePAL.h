...
class SubtitleEncorePAL : public SubtitleFormat
{
public:
	SubtitleEncorePAL(Document *doc);
	~SubtitleEncorePAL();
...
protected:
	 ...
	 */
	Glib::ustring subtitletime_to_encore_time(const SubtitleTime &time);

};

#endif//_SubtitleEncorePAL_h
