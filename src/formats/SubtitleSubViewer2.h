#ifndef _SubtitleSubViewer2_h
#define _SubtitleSubViewer2_h
...
class SubtitleSubViewer2 : public SubtitleFormat
{
public:
	SubtitleSubViewer2(Document* doc);
	~SubtitleSubViewer2();
